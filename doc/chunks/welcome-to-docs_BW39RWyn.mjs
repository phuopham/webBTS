...
function _createMdxContent(props) {
  return createVNode($$CardGrid, {
    ...
    children: [createVNode($$Card, {
      ...
      title: "工具与设备",
      icon: "seti:eslint",
      "set:html": "<p>探索 Brilliant Techno Service 的全面工具和设备系列。每个子部分提供详细的规格、使用说明和维护技巧。</p>"
    }), createVNode($$Card, {
      title: "施工服务",
      icon: "seti:puppet",
      "set:html": "<p>探索 Brilliant Techno Service 的全面工具和设备系列。每个子部分提供详细的规格、使用说明和维护技巧。</p>"
...
const file = "C:/Users/phuong/Desktop/webBTS/src/content/docs/zh-cn/welcome-to-docs.mdx";
...
Content.moduleId = "C:/Users/phuong/Desktop/webBTS/src/content/docs/zh-cn/welcome-to-docs.mdx";
