...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      "set:html": "<p>¡Bienvenido a Brilliant Techno Service Docs! Estamos emocionados de ayudarte a comenzar con nuestras herramientas premium. Esta guía está diseñada para presentarte nuestra gama de herramientas, ayudarte a comprender los conceptos básicos y ponerte al día para tu primer proyecto. ¡Sumérgete en el mundo de la artesanía de alta calidad y confiabilidad con Brilliant Techno Service!</p>\n<h2 id=\"descripción-general-de-las-herramientas\">Descripción General de las Herramientas</h2>\n"
...
const file = "C:/Users/phuong/Desktop/webBTS/src/content/docs/es/guides/getting-started.mdx";
...
Content.moduleId = "C:/Users/phuong/Desktop/webBTS/src/content/docs/es/guides/getting-started.mdx";
