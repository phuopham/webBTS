...
const frontmatter = {
  ...
  "description": "Entdecken Sie die umfassende Dokumentation von Brilliant Techno Service für einen eingehenden Einblick in unsere erstklassigen Werkzeuge und Bauleistungen.",
  "sidebar": {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      ...
      children: [createVNode($$Card, {
        ...
        "set:html": "<ul>\n<li>Erstellen Sie eine Liste aller benötigten Brilliant Techno Service Werkzeuge und Ausrüstungen.</li>\n<li>Überprüfen Sie die Verfügbarkeit und den Zustand des Inventars vor Beginn.</li>\n</ul>"
      }), createVNode($$Card, {
        title: "Dienstleistungen arrangieren",
        "set:html": "<ul>\n<li>Wenn zusätzliche Expertise oder Arbeitskräfte benötigt werden, vereinbaren Sie rechtzeitig Brilliant Techno Service Bauarbeiten.</li>\n<li>Klären Sie Service Level Agreements und Zeitpläne mit Ihrem Brilliant Techno Service Vertreter.</li>\n</ul>"
      })]
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<h2 id=\"projektumsetzung\">Projektumsetzung</h2>\n<h3 id=\"erste-phase\">Erste Phase</h3>\n"
    }), createVNode($$Steps, {
      "set:html": "<ol>\n<li>\n<p>Richten Sie den Projektstandort gemäß den Brilliant Techno Service Einrichtungsrichtlinien ein.</p>\n</li>\n<li>\n<p>Führen Sie ein erstes Teammeeting durch, um sich auf die Projektziele und Brilliant Techno Service Methodologien abzustimmen.</p>\n</li>\n<li>\n<p>Legen Sie Projektprüfpunkte und Meilensteine für regelmäßige Bewertungen fest.</p>\n</li>\n</ol>"
    }), "\n", createVNode(Fragment$1, {
      ...
      children: [createVNode($$LinkCard, {
        ...
        description: "Greifen Sie auf umfangreiche Dokumentationen und Benutzerhandbücher für Brilliant Techno Service Werkzeuge und Dienstleistungen zu.",
        href: "de/guides/getting-started"
      }), createVNode($$LinkCard, {
        title: "Support-Kontakte",
        description: "Halten Sie die Kontaktdaten für den Brilliant Techno Service Support bereit, der Ihnen während Ihres Projekts zur Verfügung steht.",
        href: "de/guides/getting-started"
      }), createVNode($$LinkCard, {
        title: "Fortgeschrittenes Lernen",
        description: "Erkunden Sie weitere Bildungsressourcen von Brilliant Techno Service, um Ihre Fähigkeiten und Ihr Wissensniveau zu verfeinern.",
        href: "de/guides/getting-started"
      })]
    })]
  });
...
const file = "C:/Users/phuong/Desktop/webBTS/src/content/docs/de/guides/first-project-checklist.mdx";
...
Content.moduleId = "C:/Users/phuong/Desktop/webBTS/src/content/docs/de/guides/first-project-checklist.mdx";
