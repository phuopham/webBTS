...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      "set:html": "<p>Dive deep into the technicalities of our product offerings with Brilliant Techno Service’s comprehensive technical specifications documentation. Our detailed data sheets provide you with all the information you need on:</p>\n"
      ...
      "set:html": "<h2 id=\"product-integration-techniques\">Product Integration Techniques</h2>\n<p>Unlock the full potential of Brilliant Techno Service products with our set of specialized integration techniques.</p>\n<p>Leverage our in-depth knowledge to enhance the efficiency and durability of your constructions by correctly incorporating our products.</p>\n<h2 id=\"advanced-use-cases\">Advanced Use Cases</h2>\n<p>Explore the possibilities with Brilliant Techno Service through real-world scenarios. Our catalog of advanced use cases demonstrates how our products can solve complex challenges and push the boundaries of conventional construction.</p>\n<p>See how Brilliant Techno Service products have been instrumental in:</p>\n"
    }), createVNode($$CardGrid, {
      ...
      "set:html": "These case studies serve as an inspiration and a learning tool, showcasing what can be achieved with the right expertise and Brilliant Techno Service’s superior product range."
    })]
  });
}
...
const file = "C:/Users/phuong/Desktop/webBTS/src/content/docs/advanced/technical-specifications.mdx";
...
Content.moduleId = "C:/Users/phuong/Desktop/webBTS/src/content/docs/advanced/technical-specifications.mdx";
