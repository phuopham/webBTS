...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      "set:html": "<p>Achieve seamless project execution with Brilliant Techno Service’s meticulous planning and management approach. We prioritize clear communication and strategic planning to ensure your project milestones are achieved without compromise.</p>\n"
    }), createVNode($$Card, {
...
const file = "C:/Users/phuong/Desktop/webBTS/src/content/docs/construction/project-planning.mdx";
...
Content.moduleId = "C:/Users/phuong/Desktop/webBTS/src/content/docs/construction/project-planning.mdx";
