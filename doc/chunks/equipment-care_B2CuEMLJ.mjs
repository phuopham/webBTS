...
import { p as $$Card, r as $$LinkCard, o as $$CardGrid, t as $$Aside } from './Code_DxNBJEzf.mjs';
import 'clsx';
...
function _createMdxContent(props) {
  return createVNode(Fragment, {
    children: [createVNode($$Card, {
      title: "Maintaining Your Brilliant Techno Service Tools",
      icon: "approve-check-circle",
      children: [createVNode($$LinkCard, {
        description: "Step-by-step guide for the routine care and maintenance of your Brilliant Techno Service tools to ensure long-lasting functionality.",
      ...
      children: [createVNode($$Card, {
        ...
        icon: "rocket",
        "set:html": "<ul>\n<li>Solutions for frequently encountered issues with Brilliant Techno Service equipment</li>\n<li>Advice on when to seek professional repair services versus performing DIY fixes</li>\n</ul>"
      })]
    }), "\n", createVNode($$Aside, {
...
const file = "C:/Users/phuong/Desktop/webBTS/src/content/docs/tools/equipment-care.mdx";
...
Content.moduleId = "C:/Users/phuong/Desktop/webBTS/src/content/docs/tools/equipment-care.mdx";
