...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      "set:html": "<p>Willkommen bei Brilliant Techno Service Docs! Wir freuen uns, Ihnen den Einstieg mit unseren erstklassigen Werkzeugen zu erleichtern. Dieser Leitfaden soll Ihnen einen Überblick über unser Werkzeugsortiment verschaffen, Ihnen die Grundlagen vermitteln und Sie für Ihr erstes Projekt fit machen. Tauchen wir gleich ein in die Welt hochwertiger und zuverlässiger Handwerkskunst mit Brilliant Techno Service.</p>\n<h2 id=\"übersicht-über-die-werkzeuge\">Übersicht über die Werkzeuge</h2>\n"
...
const file = "C:/Users/phuong/Desktop/webBTS/src/content/docs/de/guides/getting-started.mdx";
...
Content.moduleId = "C:/Users/phuong/Desktop/webBTS/src/content/docs/de/guides/getting-started.mdx";
