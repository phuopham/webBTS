...
function _createMdxContent(props) {
  return createVNode($$CardGrid, {
    ...
    children: [createVNode($$Card, {
      ...
      icon: "seti:eslint",
      "set:html": "<p>Entdecken Sie die vollständige Palette hochwertiger Werkzeuge und Ausrüstungen von Brilliant Techno Service. Jeder Unterabschnitt bietet detaillierte Spezifikationen, Gebrauchsanweisungen und Wartungstipps.</p>"
    }), createVNode($$Card, {
      title: "Bauleistungen",
      icon: "seti:puppet",
      "set:html": "<p>Entdecken Sie die vollständige Palette hochwertiger Werkzeuge und Ausrüstungen von Brilliant Techno Service. Jeder Unterabschnitt bietet detaillierte Spezifikationen, Gebrauchsanweisungen und Wartungstipps.</p>"
...
const file = "C:/Users/phuong/Desktop/webBTS/src/content/docs/de/welcome-to-docs.mdx";
...
Content.moduleId = "C:/Users/phuong/Desktop/webBTS/src/content/docs/de/welcome-to-docs.mdx";
