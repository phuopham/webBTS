...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      "set:html": "<p>Brilliant Techno Service Docsへようこそ！私たちは、プレミアムツールでのスタートをお手伝いできることを楽しみにしています。このガイドは、私たちのツールの範囲を紹介し、基本を理解し、最初のプロジェクトに備えるための設計されています。Brilliant Techno Serviceとともに、高品質で信頼性の高い技術の世界に飛び込みましょう。</p>\n<h2 id=\"ツールの概要\">ツールの概要</h2>\n"
...
const file = "C:/Users/phuong/Desktop/webBTS/src/content/docs/ja/guides/getting-started.mdx";
...
Content.moduleId = "C:/Users/phuong/Desktop/webBTS/src/content/docs/ja/guides/getting-started.mdx";
