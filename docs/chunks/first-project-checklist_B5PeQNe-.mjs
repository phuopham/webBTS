...
const frontmatter = {
  ...
  "description": "Explorez la documentation complète de Brilliant Techno Service pour un examen approfondi de nos outils haut de gamme et services de construction.",
  "sidebar": {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      ...
      children: [createVNode($$Card, {
        ...
        "set:html": "<ul>\n<li>Faites une liste de tous les outils et équipements Brilliant Techno Service nécessaires</li>\n<li>Vérifiez la disponibilité de l’inventaire et son état avant de commencer</li>\n</ul>"
      }), createVNode($$Card, {
        title: "Organisation des services",
        "set:html": "<ul>\n<li>Si une expertise supplémentaire ou une main-d’œuvre est nécessaire, organisez les services de construction Brilliant Techno Service à l’avance</li>\n<li>Clarifiez les accords de niveau de service et les délais avec votre représentant Brilliant Techno Service</li>\n</ul>"
      })]
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<h2 id=\"exécution-du-projet\">Exécution du projet</h2>\n<h3 id=\"phase-initiale\">Phase initiale</h3>\n"
    }), createVNode($$Steps, {
      "set:html": "<ol>\n<li>\n<p>Configurez le site du projet selon les directives de configuration de Brilliant Techno Service</p>\n</li>\n<li>\n<p>Organisez une réunion initiale d’équipe pour aligner les objectifs du projet et les méthodologies Brilliant Techno Service</p>\n</li>\n<li>\n<p>Établissez des points de contrôle et des jalons du projet pour des évaluations régulières</p>\n</li>\n</ol>"
    }), "\n", createVNode(Fragment$1, {
      ...
      children: [createVNode($$LinkCard, {
        ...
        description: "Accédez à une documentation approfondie et aux manuels d'utilisation des outils et services Brilliant Techno Service.",
        href: "fr/guides/getting-started"
      }), createVNode($$LinkCard, {
        title: "Contacts de support",
        description: "Gardez à portée de main les coordonnées du support Brilliant Techno Service, disponible pour vous aider tout au long de votre projet.",
        href: "fr/guides/getting-started"
      }), createVNode($$LinkCard, {
        title: "Apprentissage avancé",
        description: "Explorez d'autres ressources éducatives fournies par Brilliant Techno Service pour affiner vos compétences et vos connaissances.",
        href: "fr/guides/getting-started"
      })]
    })]
  });
...
const file = "C:/Users/phuong/Desktop/webBTS/src/content/docs/fr/guides/first-project-checklist.mdx";
...
Content.moduleId = "C:/Users/phuong/Desktop/webBTS/src/content/docs/fr/guides/first-project-checklist.mdx";
