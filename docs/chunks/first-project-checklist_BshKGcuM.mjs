...
const frontmatter = {
  ...
  "description": "مستندات جامع Brilliant Techno Service را بررسی کنید تا به طور کامل به ابزارها و خدمات ساخت و ساز ویژه ما نگاه کنید.",
  "sidebar": {
...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      "set:html": "<p>شروع یک پروژه جدید ممکن است هم به اندازه‌ای هیجان‌انگیز و هم چالش برانگیز باشد. با آماده‌سازی و هدایت مناسب، پروژه شما برای موفقیت آماده است. چک لیست اولین پروژه Brilliant Techno Service طراحی شده است تا یک رویکرد واضح و ساختارمند را برای اطمینان از آمادگی خود در هر مرحله ارائه دهد.</p>\n<h2 id=\"آمادهسازی-پروژه\">آماده‌سازی پروژه</h2>\n"
      ...
      children: [createVNode($$Card, {
        ...
        "set:html": "<ul>\n<li>تهیه لیستی از تمامی ابزارها و تجهیزات مورد نیاز Brilliant Techno Service</li>\n<li>بررسی دسترسی و شرایط موجودی قبل از شروع</li>\n</ul>"
      }), createVNode($$Card, {
        title: "مرتب‌سازی خدمات",
        "set:html": "<ul>\n<li>در صورت نیاز به تخصص یا نیروی انسانی اضافی، برنامه‌ریزی خدمات ساخت و ساز Brilliant Techno Service را به صورت پیشگامانه انجام دهید</li>\n<li>ابهامات توافق‌نامه‌های سطح خدمات و زمانبندی را با نماینده Brilliant Techno Service خود روشن کنید</li>\n</ul>"
      })]
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<h2 id=\"اجرای-پروژه\">اجرای پروژه</h2>\n<h3 id=\"فاز-اولیه\">فاز اولیه</h3>\n"
    }), createVNode($$Steps, {
      "set:html": "<ol>\n<li>\n<p>سایت پروژه را براساس راهنمای تنظیم Brilliant Techno Service راه‌اندازی کنید</p>\n</li>\n<li>\n<p>یک جلسه اولیه تیم برگزار کنید تا در مورد اهداف پروژه و روش‌های Brilliant Techno Service هماهنگ شوید</p>\n</li>\n<li>\n<p>نقاط کنترل و مراحل مهم پروژه را برای ارزیابی منظم تعیین کنید</p>\n</li>\n</ol>"
    }), "\n", createVNode(Fragment$1, {
...
const file = "C:/Users/phuong/Desktop/webBTS/src/content/docs/fa/guides/first-project-checklist.mdx";
...
Content.moduleId = "C:/Users/phuong/Desktop/webBTS/src/content/docs/fa/guides/first-project-checklist.mdx";
