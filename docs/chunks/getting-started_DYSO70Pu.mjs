...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      "set:html": "<p>欢迎来到 Brilliant Techno Service 文档！我们很高兴能帮助您开始使用我们的优质工具。本指南旨在介绍我们的工具范围，帮助您了解基础知识，并为您的第一个项目做好准备。让我们立即进入高质量、可靠的工艺世界，与 Brilliant Techno Service 一起。</p>\n<h2 id=\"工具概述\">工具概述</h2>\n"
...
const file = "C:/Users/phuong/Desktop/webBTS/src/content/docs/zh-cn/guides/getting-started.mdx";
...
Content.moduleId = "C:/Users/phuong/Desktop/webBTS/src/content/docs/zh-cn/guides/getting-started.mdx";
