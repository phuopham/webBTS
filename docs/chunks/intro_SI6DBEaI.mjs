...
import { u as $$Tabs, v as $$TabItem } from './Code_DxNBJEzf.mjs';
import 'clsx';

const frontmatter = {
  "title": "Introduction aux Services Brilliant Techno Service",
...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      "set:html": "<p>Dans le cadre de notre engagement à fournir une solution de bout en bout pour tous vos besoins en construction et matériel, nous, chez Brilliant Techno Service, sommes fiers de proposer une suite complète de services professionnels. Des consultations initiales aux inspections finales, nos services polyvalents englobent l’intégralité de votre projet, garantissant des résultats de qualité et la satisfaction du client. Cette section de la documentation vous guidera à travers tout ce que vous devez savoir pour exploiter pleinement notre expertise.</p>\n<h2 id=\"aperçu-des-services\">Aperçu des Services</h2>\n"
    }), createVNode($$Tabs, {
      children: [createVNode($$TabItem, {
        label: "Solutions sur Mesure",
        "set:html": "<p>Chaque projet de construction comporte ses propres défis et exigences. Chez Brilliant Techno Service, nous personnalisons nos services pour correspondre à vos besoins spécifiques, garantissant que, quelle que soit l’échelle ou la complexité de votre projet, notre équipe est équipée pour le gérer avec précision et professionnalisme.</p>"
      }), createVNode($$TabItem, {
...
const file = "C:/Users/phuong/Desktop/webBTS/src/content/docs/fr/guides/intro.mdx";
...
Content.moduleId = "C:/Users/phuong/Desktop/webBTS/src/content/docs/fr/guides/intro.mdx";
