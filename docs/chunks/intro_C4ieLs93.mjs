...
const frontmatter = {
  "title": "Introduction to Brilliant Techno Service Services",
...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      "set:html": "<p>As part of our commitment to providing an end-to-end solution for all your construction and hardware needs, we at Brilliant Techno Service are proud to offer a comprehensive suite of professional services. From initial consultations to final inspections, our multifaceted services encompass the entirety of your project, ensuring quality results and client satisfaction. This section of the documentation will guide you through everything you need to know to leverage our expertise to its fullest potential.</p>\n<h2 id=\"overview-of-services\">Overview of Services</h2>\n"
    }), createVNode($$Tabs, {
      children: [createVNode($$TabItem, {
        label: "Tailored Solutions",
        "set:html": "<p>Each construction project carries its unique challenges and demands. At Brilliant Techno Service, we customize our services to match your specific needs, ensuring that no matter the scale or complexity of your project, our team is equipped to handle it with precision and professionalism.</p>"
      }), createVNode($$TabItem, {
        label: "Expert Team",
...
const file = "C:/Users/phuong/Desktop/webBTS/src/content/docs/guides/intro.mdx";
...
Content.moduleId = "C:/Users/phuong/Desktop/webBTS/src/content/docs/guides/intro.mdx";
