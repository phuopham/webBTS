...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      "set:html": "<p>Welcome to Brilliant Techno Service Docs! We’re excited to help you get started with our premium tools. This guide is designed to introduce you to our tool range, help you understand the basics, and get you up to speed for your first project. Let’s jump right into the world of high-quality, reliable craftsmanship with Brilliant Techno Service.</p>\n<h2 id=\"tools-overview\">Tools Overview</h2>\n"
...
const file = "C:/Users/phuong/Desktop/webBTS/src/content/docs/guides/getting-started.mdx";
...
Content.moduleId = "C:/Users/phuong/Desktop/webBTS/src/content/docs/guides/getting-started.mdx";
