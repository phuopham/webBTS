...
function _createMdxContent(props) {
  return createVNode($$CardGrid, {
    ...
    children: [createVNode($$Card, {
      ...
      icon: "seti:eslint",
      "set:html": "<p>Découvrez la gamme complète d’outils et d’équipements de qualité supérieure de Brilliant Techno Service. Chaque sous-section offre des spécifications détaillées, des instructions d’utilisation et des conseils de maintenance.</p>"
    }), createVNode($$Card, {
...
const file = "C:/Users/phuong/Desktop/webBTS/src/content/docs/fr/welcome-to-docs.mdx";
...
Content.moduleId = "C:/Users/phuong/Desktop/webBTS/src/content/docs/fr/welcome-to-docs.mdx";
